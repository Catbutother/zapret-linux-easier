...
while IFS= read -r line; do
    line="${line//\{ipset-all\}//opt/zapret/ipset-all.txt}"
    line="${line//\{ipset-exclude\}//opt/zapret/ipset-exclude.txt}"
    line="${line//\{hosts\}//opt/zapret/hostlist.txt}"
    line="${line//\{hosts-exclude\}//opt/zapret/hostlist-exclude.txt}"
    line="${line//\{hosts-google\}//opt/zapret/hostlist-google.txt}"
    line="${line//\{hosts-all\}//opt/zapret/hostlist-all.txt}"
    line="${line//\{google-quic\}//opt/zapret/system/quic_initial_www_google_com.bin}"
    line="${line//\{google-tls\}//opt/zapret/system/tls_clienthello_www_google_com.bin}"
